function updateClock() 
{
    ...
    const hours = String(now.getHours()).padStart(2, '0'); // Get the current hours and convert it to a string, replacing it with a 2-digit format (e.g., "01", "02", ..., "23")
    const minutes = String(now.getMinutes()).padStart(2, '0'); // Get the current minutes and convert it to a string, replacing it with a 2-digit format (e.g., "00", "01", ..., "59")
    const seconds = String(now.getSeconds()).padStart(2, '0'); // Get the current seconds and convert it to a string, replacing it with a 2-digit format (e.g., "00", "01", ..., "59")
